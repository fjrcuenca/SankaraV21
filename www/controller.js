...
angular.module('SankaraEye', ['ionic', 'ngCordova'])
 ...
 */
.controller('LanguageCtrl', function($http, $scope, $state, $rootScope) {
  	$scope.ENGLISH = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.English;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
			$rootScope.create_account = $rootScope.masterTranslations.create_account;
			$rootScope.select_another_language = $rootScope.masterTranslations.select_another_language;
		});
		// DO SOMETHING
		console.log('English');
		$state.go('sign_in');
  	...
  	$scope.GUJARATI = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Gujarati;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.HINDI = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Hindi;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.KANNADA = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Kannada;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.MARATHI = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Marathi;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
	...
	$scope.PUNJABI = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Punjabi;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.TAMIL = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Tamil;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.TELUGU = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Telugu;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
  	...
  	$scope.URDU = function() {
		$http.get('translations.json').success(function(data) {
			$rootScope.translation = data;
			$rootScope.masterTranslations = $rootScope.translation.Urdu;
			$rootScope.sign_in = $rootScope.masterTranslations.sign_in;
			$rootScope.username = $rootScope.masterTranslations.username;
			$rootScope.password = $rootScope.masterTranslations.password;
			$rootScope.log_in = $rootScope.masterTranslations.log_in;
 ...
 */
.controller('CreateAccountCtrl', function($scope, $rootScope, $state, $http, $ionicPopup) {

	$scope.createNewAccount = function(data) {
		console.log('Create New Account');
		if (!data.new_username || !data.new_password || !data.new_password2 || !data.pin) {
			var alertPopup = $ionicPopup.alert({
				title: '<center> <b> Please fill in missing fields </b> </center>',
				template: '<center> <b> Try Again </b> </center>'
			});
		...
		} else if (data.pin != $rootScope.masterPin) {
			var alertPopup3 = $ionicPopup.alert({
				title: '<center> <b> Wrong Pin </b> </center>',
				template: '<center> <b> Try Again </b> </center>'
			});
			alertPopup3.then(function(res) {
				console.log('Try Pin Again');
			});
		} else {
 ...
 */
.controller('SchoolProfileCtrl', function($state, $scope, $rootScope, $stateParams, ScreeningSiteService, $http, $ionicLoading, $ionicModal, $ionicPopup) {
...
// User must enter in a PIN in order to delete a school!
		$scope.pin = {}
		var pinPopup = $ionicPopup.show({
			template: '<input type="text" ng-model="pin.entered">',
			title: 'Enter PIN',
			scope: $scope,
			buttons: [
				{ text: 'Cancel' },
				{
					...
					type: 'button-positive',
						onTap: function(e) {
							if (!$scope.pin.entered) {
								//don't allow the user to close unless he enters wifi password
								var noPinPopup = $ionicPopup.alert({
									title: 'Enter In Pin'
								});
								noPinPopup.then(function(res) {
									console.log('No Pin Entered');
								});
								e.preventDefault();
							} else if ($scope.pin.entered != $rootScope.masterPin) { 
								var wrongPinPopup = $ionicPopup.alert({
									title: 'Wrong Pin'
								});
								wrongPinPopup.then(function(res) {
 ...
 */
.controller('StudentProfileCtrl', function($state, $scope, $rootScope, $stateParams, ScreeningSiteService, $http, $ionicLoading, $ionicPopup) {
	...
	var site_name = $stateParams.site_name;
	var firstname = $stateParams.firstname;
	var lastname = $stateParams.lastname;
	var parent_name = $stateParams.parent_name;
...
// User must enter in a PIN in order to delete a student!
		$scope.pin = {}
		var pinPopup = $ionicPopup.show({
			template: '<input type="text" ng-model="pin.entered">',
			title: 'Enter PIN',
					...
					type: 'button-positive',
						onTap: function(e) {
							if (!$scope.pin.entered) {
								...
								pinPopup.then(function(res) {
									var confirmPopup = $ionicPopup.confirm({
										title: '<center> <b> Are you sure you want to delete this student? </b> </center>',
									});
									confirmPopup.then(function(res) {
										if(res) {
											console.log('Deleting ' + firstname + ' ' + lastname);
											var url = "db.php?action=delete_student&site=";
											url += site;
											url += "&site_name=";
											url += site_name;
											url += "&firstname=";
											...
											.success(function (data, status, headers, config) {
												var alertPopup2 = $ionicPopup.alert({
													title: '<center> <b> Deleted ' + firstname + ' ' + lastname + ' </b> </center>'
												});
												alertPopup2.then(function(res) {
												});				
												$state.go('sidemenu.home');
 ...
 *	(TODO) Should reroute back to previously visited page!
 */
.controller('AddStudentProfileCtrl', function($scope, $http, $state, $ionicPopup, $stateParams, $cordovaCamera) {
	...
	$scope.takePhoto = function() {
		...
		var options = {
		    ...
		    saveToPhotoAlbum: false //change to true if you want to store in album
		};
	...
	// TODO: GO TO STUDENT'S PROFILE!
				...
				} else if (data.site == 'Camp') {
					$http.post(url, 
					{
						'camp'			: data.screening_site,
						'firstname'             : data.firstname,
						'lastname'              : data.lastname,
						'gender'                : data.gender,
						'birth_date'            : data.birth_date,
 ...
 *	(TODO) Should reroute back to previously visited page!
 */
.controller('AddStudentToSchoolCtrl', function($scope, $http, $state, $ionicPopup, $stateParams, $cordovaCamera) {
 ...
 *	(TODO) Should reroute back to previously visited page!
 */
.controller('AddStudentToCampCtrl', function($scope, $http, $state, $ionicPopup, $stateParams, $cordovaCamera) {
 ...
 *	(TODO) Should reroute back to previously visited page!
 */
.controller('AddStudentToAnganwadiCtrl', function($scope, $http, $state, $ionicPopup, $stateParams, $cordovaCamera) {
